...
1. Twitter/X: [@antonbabenko](https://x.com/antonbabenko), [@weeklytf](https://x.com/weeklytf), [@compliancetf](https://x.com/compliancetf)
...
To book ads in weekly.tf, the YouTube channel, or other projects - [Passionfroot](https://workspace.passionfroot.me/antonbabenko) is the primary platform.
...
### [compliance.tf](https://compliance.tf) - Compliance-ready Terraform modules

Terraform modules with SOC 2, PCI DSS, HIPAA, NIST 800-53, and 35+ other frameworks built in. Non-compliant configurations fail at `terraform plan` - before you can apply anything. See the [docs](https://compliance.tf/docs/) or [start a free trial](https://compliance.tf/free-trial/).

See also [awesome-terraform-compliance](https://github.com/antonbabenko/awesome-terraform-compliance) - a curated list of tools, frameworks, and resources for Terraform compliance and security.
...
* [Беларуская (Belarusian)](https://www.terraform-best-practices.com/v/be/) by [Jaŭhien Sliapcoŭ](https://www.linkedin.com/in/sliapcou/)
...
* [日本語 (Japanese)](https://www.terraform-best-practices.com/v/ja/) by [Takashi Okamoto](https://x.com/o_takashi3) and [Shogo Tanaka](https://www.linkedin.com/in/shogo-tanaka-034891248/)
* [ಕನ್ನಡ (Kannada)](https://www.terraform-best-practices.com/v/kn/) by [Trivikrama Harikrishnan](https://www.linkedin.com/in/trivih/)
* [Қазақша (Kazakh)](https://www.terraform-best-practices.com/v/kk/) by [Arman Nurgaliyev](https://www.linkedin.com/in/nurgaliyev/)
...
1. [modules.tf](https://modules.tf) - Visual Studio Code extension for Terraform. Development paused; not actively maintained.
1. [Diagrams to code (d2c) - Infrastructure as code generator - from visual diagrams created with Cloudcraft.co to Terraform](https://github.com/antonbabenko/modules.tf-lambda) - built using [serverless.tf framework](https://serverless.tf).
